...
p{
  ...
  <div class="panel panel-default">
    ...
    <h2 id="table_info_jk">二.课程表接口</h3>
		<!--2-1-->
		<div id="2-1">
		<h3 id="two_one">2-1 正常请求课表 &nbsp;&nbsp;Curriculum_Usert&nbsp;&nbsp;&nbsp;      POST</h3>
		<P>接口相关参数：A:Curriculum_User；AC:getForCurrentTerm</P>
  ...
  <div class="panel panel-default">
    ...
    <div id="two_one_suceess" class="panel-collapse collapse in">
      <div class="panel-body">
		...
		<P>结果成功案例："{"S":"success","C":"6f7308f3fb450aadd0330e4e32ebd319","E":1,"M":null,"MT":null,"V":["calid","sclid1","year","half","week","beginday","scl_time","class"],"calid":"1","sclid1":"631","year":"2014","half":"2","week":"21","beginday"......}"	</P>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
